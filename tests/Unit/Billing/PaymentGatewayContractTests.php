...
trait PaymentGatewayContractTests
{
    ...
    public function can_get_details_about_a_successful_charge()
    {
        ...
        $charge = $paymentGateway->charge(7000, $paymentGateway->getValidTestToken($paymentGateway::TEST_CARD_NUMBER));

        $this->assertEquals(substr($paymentGateway::TEST_CARD_NUMBER, -4), $charge->cardLastFour());
        $this->assertEquals(7000, $charge->amount());
    }
    ...
    function can_fetch_charges_created_during_a_callback()
    {
        ...
        $this->assertCount(2, $newCharges);
        $this->assertEquals(9000, $newCharges->map->amount()->sum());
